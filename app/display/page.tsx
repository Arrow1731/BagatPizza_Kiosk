...
//         // Устанавливаем timestamp для нового готового заказа
//         newOrders.forEach((order) => {
//           if (order.id) {
//             setReadyOrderTimestamps((prev) => {
//               const newMap = new Map(prev)
//               newMap.set(order.id!, new Date().toISOString()) // Текущее время для таймера
//               return newMap
//             })
//           }
//         })
...
//               try {
//                 console.log(`Auto-completing order #${order.orderNumber} after 1 minute`)
//                 await updateOrderStatus(order.id, "completed")
...
//                     className={`backdrop-blur-sm border rounded-xl p-6 hover:scale-105 transition-all duration-300 ${
//                       timeInfo.isExpiring
//                         ? "bg-gradient-to-r from-green-500/30 to-green-500/30 border-green-400/50 animate-pulse"
//                         : timeInfo.isWarning
//                           ? "bg-gradient-to-r from-green-500/20 to-green-500/20 border-green-400/40"
//                           : "bg-gradient-to-r from-green-500/20 to-emerald-500/20 border-green-400/30"
//                     }`}
