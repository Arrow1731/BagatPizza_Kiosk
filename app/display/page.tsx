...
//         <div className="w-1/2 border-r border-white/10 p-10 overflow-y-3">
//           <div className="text-center mb-3">
//             <div className="flex items-center justify-center gap-4 mb-2">
//               <Clock className="h-5 w-5 text-orange-400" />
//               <h2 className="text-2xl sm:text-2xl lg:text 2xl font-medium text-orange-400">
//                 TAYYORLANMOQDA
//               </h2>
//             </div>
//             <p className="text-xl text-orange-300 font-[12px]">
...
//               <h2 className="text-xl sm:text-xl lg:text-3xl font-medium text-emerald-400">
//                 TAYYOR
//               </h2>
//             </div>
...
//                         <div className="text-center">
//                           <Badge
//                             className={`text-white text-sm font-bold px-4 py-1 border-0 ${
...
//                           </Badge>
//                           <div
//                             className={`text-xs mt-2 font-mono font-medium ${
//                               timeInfo.isExpiring
//                                 ? "text-freen-300"
//                                 : timeInfo.isWarning
//                                   ? "text-green-300"
...
export default function DisplayPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      {/* Header */}
      <header className="relative z-10 text-center py-4 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-yellow-400 mb-2">Bog'ot Pizza N1</h1>
          {currentTime && (
            <div className="flex items-center justify-center gap-3 text-base text-purple-200">
      ...
      {/* Two-Column Layout */}
      <div className="relative z-10 h-[calc(100vh-140px)] flex">
        {/* LEFT SIDE - PREPARING ORDERS */}
        <div className="w-1/2 border-r border-white/10 p-2 overflow-y-auto">
          <div className="text-center mb-4">
            <div className="flex items-center justify-center gap-3 mb-2">
              <Clock className="h-6 w-6 text-orange-400" />
              <h2 className="text-2xl font-bold text-orange-400">TAYYORLANMOQDA</h2>
            </div>
          ...
          <div className="space-y-3">
            {sortedPreparingOrders.length > 0 ? (
              sortedPreparingOrders.map((order, index) => (
                <div
                  key={order.id || `preparing-${index}`}
                  className="bg-gradient-to-r from-orange-500/20 to-yellow-500/20 backdrop-blur-sm border border-orange-400/30 rounded-xl p-2 hover:scale-105 transition-transform duration-300"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-white">Buyurtma #{order.orderNumber}</div>
                        <div className="text-orange-300 text-sm font-medium">Tayyorlanmoqda</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <Badge className="bg-orange-500 text-white text-sm font-bold px-3 py-1 border-0">
              ...
              <div className="flex flex-col items-center justify-center h-64 text-center">
                <ChefHat className="h-16 w-16 text-orange-400/50 mb-4" />
                <p className="text-xl text-orange-400/70 font-medium">Tayyorlanayotgan buyurtmalar yo'q</p>
                <p className="text-orange-400/50 mt-2">Barcha buyurtmalar bajarildi</p>
              </div>
            )}
          </div>
        ...
        <div className="w-1/2 p-2 overflow-y-auto">
          <div className="text-center mb-4">
            <div className="flex items-center justify-center gap-3 mb-2">
              ...
              <h2 className="text-2xl font-semibold text-green-400">TAYYOR</h2>
            </div>
            <p className="text-lg text-green-300 font-medium">{sortedReadyOrders.length} ta buyurtma tayyor</p>
          </div>
          <div className="space-y-3">
            {sortedReadyOrders.length > 0 ? (
              sortedReadyOrders.map((order, index) => {
                const timeInfo = order.id
                  ? getRemainingTime(order.id)
                  : { time: "1:00", isExpiring: false, isWarning: false }
                return (
                  <div
                    key={order.id || `ready-${index}`}
                    className={`backdrop-blur-sm border rounded-xl p-2 hover:scale-105 transition-all duration-300 ${
                      timeInfo.isExpiring
                        ? "bg-gradient-to-r from-green-500/30 to-green-500/30 border-green-400/50"
                        : timeInfo.isWarning
                          ? "bg-gradient-to-r from-green-500/20 to-green-500/20 border-green-400/40"
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="text-center">
                          <Badge
                            className={`text-white text-sm font-bold px-3 py-1 border-0 ${
                              timeInfo.isExpiring ? "bg-green-500" : timeInfo.isWarning ? "bg-green-500" : "bg-green-500"
                            }`}
                          >
                            <Sparkles className="h-3 w-3 mr-1" />
                            {timeInfo.isExpiring ? "Tayyor!" : "TAYYOR!"}
                          </Badge>
                          <div
              ...
              <div className="flex flex-col items-center justify-center h-64 text-center">
                <CheckCircle className="h-16 w-16 text-green-400/50 mb-4" />
                <p className="text-xl text-green-400/70 font-medium">Tayyor buyurtmalar yo'q</p>
                <p className="text-green-400/50 mt-2">Buyurtmalar tayyorlangandan keyin bu yerda ko'rinadi</p>
              </div>
            )}
          </div>
