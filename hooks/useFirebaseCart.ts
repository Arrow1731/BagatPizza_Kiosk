...
// type DeliveryMethod = "pickup" | "delivery" | "takeaway"
...
//   useEffect(() => {
//     // Simulate fetching cart data from Firebase
//     setTimeout(() => {
//       const mockCart = [
//         {
//           id: 1,
...
//   useEffect(() => {
//     // Update total items and price whenever the cart changes
...
//     setCart((prevCart) =>
//       prevCart.map((item) => (item.id === itemId ? { ...item, quantity: Math.max(0, newQuantity) } : item)),
//     )
//   }
